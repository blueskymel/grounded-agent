...
## FDE Hallucination Demo

To demonstrate Forward Deployed Engineering workflows (issue reproduction, safe fix path, and repeatable client rollout), use:

- `docs/FDE-HALLUCINATION-DEMO.md`
